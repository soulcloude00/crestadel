...
class _CommunityPageState extends State<CommunityPage> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _posts = [
    ...
    },
    {
      ...
      'handle': '@cardano_memes',
      'verified': true,
      'time': '3h ago',
      'content': 'POV: You\'re at a hackathon and spot that \$2k meme integration award 😂💀\n\n"Imma just add a Cardano meme for that \$2k"\n\nMeanwhile the actual project demo: 👀\n\n#CardanoMemes #Hackathon #Crestadel',
      'image': 'assets/images/meme_hackathon.png',
      'likes': 892,
      'comments': 156,
      'shares': 234,
      'liked': false,
    ...
    },
    {
      ...
      'verified': true,
      'time': '6h ago',
      'content': 'Drake knows what\'s up 🙌\n\n❌ Cardano Memes for the \$2k Award\n✅ Cardano Core - Decentralized Governance, Plutus, Scalability\n\n"Yeah, let\'s focus on the real tech."\n\n#Cardano #BuildOnCardano',
      'image': 'assets/images/meme_drake_cardano.png',
      'likes': 1247,
      'comments': 203,
      'shares': 445,
      'liked': true,
    ...
    {
      'id': '8',
      'user': 'Peter Griffin ADA',
      'avatar': 'https://i.pravatar.cc/150?img=33',
      'handle': '@peter_builds_ada',
      'verified': true,
      'time': '1h ago',
      'content': 'Peter at Cardano Hackathon Asia 2025 be like... 🤣\n\n"See? I\'m integrating Cardano culture into the demo. It\'s flawless!"\n\n*Charles flying to the moon* 🚀\n\nThis is how we win that \$2k Best Meme Integration Award 💀\n\n#CardanoHackathon #ToTheMoon #CardanoCulture',
      'image': 'assets/images/meme_peter_hackathon.png',
      'likes': 2341,
      'comments': 387,
      'shares': 612,
      'liked': false,
    ...
    {
      'id': '9',
      'user': 'Springfield ADA',
      'avatar': 'https://i.pravatar.cc/150?img=15',
      'handle': '@simpsons_cardano',
      'verified': true,
      'time': '30m ago',
      'content': 'Homer vs Lisa energy 😂\n\n🍩 General Crypto Market: Chasing pumps at the nuclear plant\n\n📚 Cardano: Built for the Future, Not the Hype\n\nAcademic peer-review & formal methods >>> FOMO\n\nSustainable. Secure. Scalable Growth. 📈\n\n#Cardano #DYOR #NotTheHype',
      'image': 'assets/images/meme_simpsons_cardano.png',
      'likes': 3156,
      'comments': 421,
      'shares': 789,
      'liked': true,
    ...
    },
    {
      ...
      'handle': '@charles_to_hollywood',
      'verified': true,
      'time': '15m ago',
      'content': 'Cardano Community when Charles gets a Hollywood star ⭐🎬\n\n"Finally, some real utility." 😎\n\nRed carpet treatment for the blockchain that actually delivers! 🚀\n\n#Cardano #CharlesHoskinson #Hollywood #RealUtility',
      'image': 'assets/images/meme_hollywood_charles.png',
      'likes': 4892,
      'comments': 634,
      'shares': 1247,
      'liked': false,
          ...
          children: [
            ...
            if (post['image'] != null) ...[
              ...
              ClipRRect(
                ...
                child: post['image'].toString().startsWith('assets/')
                  ? Image.asset(
                      post['image'],
                      height: post['isMeme'] == true ? 280 : 200,
